/**
 * Sign-in page for Google OAuth authentication.
 * 
 * Provides a clean, branded interface for users to sign in with Google
 * and grant GA4 analytics access.
 */
      ...
      <div className="max-w-md w-full bg-white rounded-lg shadow-xl p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            AI-powered insights for your Google Analytics data
          </p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          <p>
            By signing in, you grant access to your Google Analytics data.
          </p>
          <p className="mt-2">
            We only request read-only access (analytics.readonly scope).
          </p>
        </div>
        ...
        <div className="mt-8 border-t border-gray-200 pt-6">
          ...
          <ul className="space-y-2 text-sm text-gray-600">
            <li className="flex items-start">
              ...
              <span>Conversational analytics queries</span>
            </li>
            <li className="flex items-start">
              <svg
                className="h-5 w-5 text-green-500 mr-2 flex-shrink-0"
